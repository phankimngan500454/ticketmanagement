...
--
-- Class Department as table departments
--
...
--
-- Class EmergencyContact as table emergency_contacts
--
...
--
-- Class TicketEvent as table ticket_events
--
...
--
-- Foreign relations for "emergency_contacts" table
--
...
--
-- Foreign relations for "ticket_events" table
--
ALTER TABLE ONLY "ticket_events"
    ADD CONSTRAINT "ticket_events_fk_0"
    FOREIGN KEY("ticketId")
    REFERENCES "tickets"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "ticket_events"
    ADD CONSTRAINT "ticket_events_fk_1"
    FOREIGN KEY("userId")
    REFERENCES "app_users"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('ticketmanagement_server', '20260504024205474', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260504024205474', "timestamp" = now();
