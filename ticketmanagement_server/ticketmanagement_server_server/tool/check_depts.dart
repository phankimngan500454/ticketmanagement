// ignore_for_file: avoid_print, depend_on_referenced_packages, curly_braces_in_flow_control_structures
...
void main() async {
  ...
  ''');
  if (dupNames.isEmpty) {
    print('  Không có duplicate name');
  } else {
    for (final row in dupNames) {
